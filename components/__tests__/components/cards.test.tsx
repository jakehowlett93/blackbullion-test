...
describe('PathwayCard', () => {
  it('renders without errors', () => {
    ...
    expect(getByText('Learn what funding is available when you start uni and how you can get the best out of it.')).toBeTruthy();
  ...
  it('opens pathway URL on press', () => {
    ...
    expect(Linking.openURL).toHaveBeenCalledWith('https://www.blackbullion.com/pathways/starting-university-uk');
  });
