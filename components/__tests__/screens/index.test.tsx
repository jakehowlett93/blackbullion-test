...
describe('LibraryScreen', () => {
  ...
  it('renders loading screen when isLoading is true', () => {
    jest.spyOn(require('@/hooks/useLearningPathways.tsx'), 'useLearningPathways').mockReturnValue({
      isLoading: true,
    });
  ...
  it('renders without errors', async () => {
    jest.spyOn(require('@/hooks/useLearningPathways.tsx'), 'useLearningPathways').mockReturnValue(mockData);
